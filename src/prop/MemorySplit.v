...
Module MemorySplit.
  Lemma remove_lower_remove
        ...
        (REL_WF1: View.opt_wf msg1.(Message.view))
        (REL_WF2: View.opt_wf msg2.(Message.view))
        (TS: Time.lt from to)
  ...
  Lemma remove_promise_remove
        ...
        (TS: Time.lt from to)
        (REMOVE: Memory.remove promises0 loc from to (Message.mk val released1) promises2):
    exists promises1' mem1',
      <<PROMISE: Memory.promise promises0 mem0 loc from to (Message.mk val released2) promises1' mem1' (Memory.op_kind_lower (Message.mk val released1))>> /\
      <<REMOVE: Memory.remove promises1' loc from to (Message.mk val released2) promises2>>.
  Proof.
    exploit remove_lower_remove; eauto; ss.
    { econs. eauto. }
    { eauto. }
    i. des.
  ...
  Lemma remove_promise_promise_remove_remove
        ...
        (WF2: View.opt_wf msg2.(Message.view))
        (TS2: Time.le (msg2.(Message.view).(View.unwrap).(View.rlx) loc) ts2)
